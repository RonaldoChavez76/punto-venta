...
@Component({
  selector: 'app-pantalla-principal-em',
  templateUrl: './pantalla-principal-em.component.html',
  styleUrl: './pantalla-principal-em.component.css'
})
export class PantallaPrincipalEmComponent {
