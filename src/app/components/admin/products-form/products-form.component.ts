...
export class ProductsFormComponent {
  ...
  constructor(private productosService: ProductosService, private router: Router, private activatedRoute: ActivatedRoute, private _CargaScripts: CargarScriptsService) {
