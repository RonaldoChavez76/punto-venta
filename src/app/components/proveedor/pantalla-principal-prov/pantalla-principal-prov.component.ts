...
@Component({
  selector: 'app-pantalla-principal-prov',
  templateUrl: './pantalla-principal-prov.component.html',
  styleUrl: './pantalla-principal-prov.component.css'
})
export class PantallaPrincipalProvComponent {
